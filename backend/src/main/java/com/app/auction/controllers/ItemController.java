...
public class ItemController {
	...
	public ResponseEntity<ItemDto> createItem(@Valid @RequestBody ItemDto ItemDto, @PathVariable int userId) {
	...
	public ResponseEntity<ItemDto> getById(@PathVariable int itemId) {
		ItemDto items = itemService.getById(itemId);
